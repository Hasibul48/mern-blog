        ...
        <div className='container md:flex items-center mb-44'>
            ...
            <div className="flex-1 justify-center items-center flex mt-[-12%] md:mt-[8%]">
                <form className='w-3/5' onSubmit={handleSubmit}>
                    <h3 className='font-bold text-3xl text-center pb-3'>Let's Login within a single minute!</h3>
                    <div className='my-4'>
                    ...
                    <Button type='submit' disabled={isLoading} className='mx-auto w-4/5 rounded-2xl' gradientDuoTone="redToYellow">{isLoading ? 'Loading...' : "Login"}</Button>
                    <p className='mt-3'>Don't have an account? <Link className='text-yellow-500 font-semibold' to={'/signup'}>Sign up</Link></p>
